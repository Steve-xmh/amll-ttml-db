...
> [!CAUTION]
>
> 请不要直接提交来自 Apple Music 的 TTML 歌词文件，因为这些文件的分词和时间轴并不完全准确合理。如果发现投稿人存在大批量搬运 Apple Music TTML 歌词文件的行为，那么此投稿人的所有投稿还将被打上「慢速审核队列」甚至「暂停审核」标签。
...
感谢各位对 AMLL 生态作品感兴趣的用户，也欢迎加入 AMLL 亲友团 QQ 群 `678038548` 参与讨论。
